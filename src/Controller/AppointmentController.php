...
final class AppointmentController extends AbstractController
{
    ...
    #[Route('admin/appointment/{id}', name: 'app_appointment_show', methods: ['GET'])]
    ...
    #[Route('admin/appointment/{id}/edit', name: 'app_appointment_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('admin/appointment/{id}', name: 'app_appointment_delete', methods: ['POST'])]
